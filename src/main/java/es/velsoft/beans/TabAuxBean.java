...
import es.velsoft.dao.ListaTADAO;
import es.velsoft.dao.TablasAuxiliaresDAO;
import es.velsoft.modelo.IdNombreObj;
import es.velsoft.modelo.ListaTA;
...
public class TabAuxBean implements Serializable {
    ...
    public void onRowDelete(TablaAux aux) {
        LOG.log(Level.INFO, "En onRowDelete. Voy a borrar el registro: {0}", aux.toString());
